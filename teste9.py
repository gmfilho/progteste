...
def abrir():
    with open('C:\\Users\\gilbe\\Documents\\Mestrado\\Programação\\Aula 08\\coletaFlexJoelho.csv', 'r') as fileobj:
...
with open('C:\\Users\\gilbe\\Documents\\Mestrado\\Programação\\Aula 08\\coletaFlexJoelho.csv', 'r', newline='') as csvfile:
